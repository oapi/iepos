(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();const Jt=new Map;let Kt=null,Lt=null;function x(e,s){Jt.set(e,s)}function de(e){Kt=e}function pe(e){Lt=e}function ue(){const e=window.location.hash;return!e||e==="#"?"/":e.slice(1)}function me(e){for(const[s,n]of Jt){const a=[],o=s.replace(/:([^/]+)/g,(l,d)=>(a.push(d),"([^/]+)")),r=new RegExp(`^${o}$`),i=e.match(r);if(i){const l={};return a.forEach((d,p)=>{l[d]=i[p+1]}),{handler:n,params:l}}}return null}async function Rt(){const e=ue(),s=me(e),n=(s==null?void 0:s.handler)||Kt,a=(s==null?void 0:s.params)||{};Lt&&!await Lt(e,a)||n&&await n(a)}function C(e){window.location.hash=e}function ve(){window.addEventListener("hashchange",Rt),Rt()}const be={app:{name:"CoreTrade ERP",company:"Islam Enterprise",loading:"Loading…",saving:"Saving…",deleting:"Deleting…",error:"An error occurred",retry:"Retry",back:"Back",close:"Close",cancel:"Cancel",confirm:"Confirm",save:"Save",delete:"Delete",edit:"Edit",add:"Add",view:"View",print:"Print",export:"Export CSV",import:"Import CSV",search:"Search…",filter:"Filter",clear:"Clear",submit:"Submit",update:"Update",noData:"No data found",selectOption:"Select…",actions:"Actions",status:"Status",active:"Active",inactive:"Inactive",yes:"Yes",no:"No",all:"All",today:"Today",thisMonth:"This Month",custom:"Custom Range",from:"From",to:"To",date:"Date",notes:"Notes",optional:"Optional",required:"Required",total:"Total",subtotal:"Subtotal",discount:"Discount",paid:"Paid",due:"Due",balance:"Balance"},auth:{login:"Login",logout:"Logout",username:"Username",password:"Password",loginBtn:"Login to ERP",loggingIn:"Logging in…",logoutConfirm:"Are you sure you want to logout?",changePassword:"Change Password",currentPassword:"Current Password",newPassword:"New Password",confirmPassword:"Confirm Password",passwordChanged:"Password changed successfully",invalidCredentials:"Invalid username or password",sessionExpired:"Session expired. Please login again.",welcome:"Welcome back"},nav:{dashboard:"Dashboard",pos:"POS",sales:"Sales",purchases:"Purchases",products:"Products",inventory:"Inventory",customers:"Customers",suppliers:"Suppliers",payments:"Payments",accounts:"Accounts",expenses:"Expenses",reports:"Reports",users:"Users",settings:"Settings",backup:"Backup",customerPayments:"Customer Payments",supplierPayments:"Supplier Payments"},dashboard:{title:"Dashboard",todaySales:"Today's Sales",todayPurchases:"Today's Purchases",todayExpenses:"Today's Expenses",todayProfit:"Today's Profit",paymentsReceived:"Payments Received",customerDue:"Customer Due",supplierDue:"Supplier Due",cashBalance:"Cash Balance",bankBalance:"Bank Balance",totalAvailable:"Total Available",lowStockAlert:"Low Stock Alert",recentSales:"Recent Sales",quickActions:"Quick Actions",salesTrend:"Sales Trend (30 days)",lowStockItems:"{n} items low on stock",viewLowStock:"View Low Stock",noRecentSales:"No sales today"},quick:{newSale:"New Sale",newPurchase:"New Purchase",receivePayment:"Receive Payment",paySupplier:"Pay Supplier",addExpense:"Add Expense",addProduct:"Add Product",addCustomer:"Add Customer"},pos:{title:"Point of Sale",searchProduct:"Search product by name, SKU…",cart:"Cart",emptyCart:"Cart is empty. Add products to start.",product:"Product",qty:"Qty",unit:"Unit",unitPrice:"Unit Price",itemDiscount:"Item Discount",itemTotal:"Total",removeItem:"Remove item",clearCart:"Clear Cart",clearCartConfirm:"Are you sure you want to clear the cart?",orderSummary:"Order Summary",saleType:"Sale Type",cashSale:"Cash Sale",creditSale:"Credit Sale",wholesaleSale:"Wholesale",selectCustomer:"Select Customer",paymentAccount:"Payment Account",amountPaid:"Amount Paid",changeDue:"Change Due",completeSale:"Complete Sale",completingLoading:"Processing…",saleSuccess:"Sale completed successfully",invoiceNo:"Invoice",printReceipt:"Print Receipt",newSale:"New Sale",insufficientStock:"Insufficient stock for",available:"Available",customerRequired:"Please select a customer for credit sale",accountRequired:"Please select a payment account",itemsRequired:"Please add at least one item",unitPriceRequired:"Enter unit price for all items"},products:{title:"Products",add:"Add Product",edit:"Edit Product",delete:"Deactivate Product",deleteConfirm:"Deactivate this product? It will not appear in POS.",name:"Product Name",nameBn:"Product Name (Bangla)",sku:"SKU / Code",category:"Category",brand:"Brand",size:"Size",unit:"Unit",retailPrice:"Retail Price",wholesalePrice:"Wholesale Price",purchaseCost:"Purchase Cost",currentStock:"Current Stock",openingStock:"Opening Stock",lowStockAlert:"Low Stock Alert",isActive:"Active",notes:"Notes",basicInfo:"Basic Information",pricing:"Pricing",inventory:"Inventory",saved:"Product saved successfully",noProducts:"No products found",lowStockBadge:"Low Stock",searchPlaceholder:"Search by name, SKU, brand…",filterCategory:"Filter by category",showLowStock:"Low stock only"},categories:{title:"Categories",add:"Add Category",edit:"Edit Category",name:"Category Name",nameBn:"Category Name (Bangla)",slug:"Slug",sortOrder:"Sort Order",saved:"Category saved",deleted:"Category deleted",hasProducts:"Category has products. Deactivate instead."},inventory:{title:"Inventory",movements:"Stock Movements",adjust:"Adjust Stock",adjustIn:"Stock In (Add)",adjustOut:"Stock Out (Remove)",lowStock:"Low Stock",summary:"Stock Summary",adjustConfirm:"Record stock adjustment?",product:"Product",movementType:"Type",qty:"Quantity",balanceAfter:"Balance After",reference:"Reference",reason:"Reason",adjustSuccess:"Stock adjusted successfully",movementTypes:{purchase:"Purchase",sale:"Sale",return_in:"Return In",return_out:"Return Out",adjustment_in:"Adjustment In",adjustment_out:"Adjustment Out",opening:"Opening Stock"},stockValue:"Stock Value",costValue:"Cost Value",retailValue:"Retail Value"},customers:{title:"Customers",add:"Add Customer",edit:"Edit Customer",delete:"Delete Customer",deleteConfirm:"Delete this customer? This cannot be undone.",name:"Customer Name",phone:"Phone",address:"Address",creditLimit:"Credit Limit",currentDue:"Current Due",lastTransaction:"Last Transaction",ledger:"View Ledger",receivePayment:"Receive Payment",newSale:"New Sale",saved:"Customer saved",noCustomers:"No customers found",searchPlaceholder:"Search by name or phone…"},suppliers:{title:"Suppliers",add:"Add Supplier",edit:"Edit Supplier",delete:"Delete Supplier",deleteConfirm:"Delete this supplier?",name:"Supplier Name",phone:"Phone",address:"Address",currentDue:"Current Payable",lastTransaction:"Last Transaction",ledger:"View Ledger",makePayment:"Make Payment",newPurchase:"New Purchase",saved:"Supplier saved",noSuppliers:"No suppliers found"},ledger:{title:"Ledger",date:"Date",description:"Description",debit:"Debit",credit:"Credit",balance:"Balance",openingBalance:"Opening Balance",closingBalance:"Closing Balance",noEntries:"No ledger entries for this period"},sales:{title:"Sales",invoice:"Invoice No.",date:"Sale Date",customer:"Customer",type:"Type",total:"Total",paid:"Paid",due:"Due",status:"Status",void:"Void Sale",voidConfirm:"Void this sale? Stock will be restored.",voidReason:"Void Reason",voided:"Voided",completed:"Completed",viewInvoice:"View Invoice",noSales:"No sales found",types:{cash:"Cash",credit:"Credit",wholesale:"Wholesale"}},purchases:{title:"Purchases",add:"New Purchase",invoice:"Purchase No.",date:"Purchase Date",supplier:"Supplier",total:"Total",paid:"Paid",due:"Due",noPurchases:"No purchases found",saved:"Purchase recorded successfully"},payments:{customerTitle:"Customer Payments",supplierTitle:"Supplier Payments",receivePayment:"Receive Payment",makePayment:"Make Payment",customer:"Customer",supplier:"Supplier",amount:"Amount",method:"Payment Method",reference:"Reference No.",account:"Account",paymentDate:"Payment Date",recorded:"Payment recorded successfully",methods:{cash:"Cash",bank_transfer:"Bank Transfer",cheque:"Cheque",mobile_banking:"Mobile Banking"}},accounts:{title:"Accounts",add:"Add Account",edit:"Edit Account",name:"Account Name",type:"Account Type",balance:"Balance",statement:"Statement",deposit:"Deposit",withdraw:"Withdraw",transfer:"Transfer",transferTo:"Transfer To",amount:"Amount",description:"Description",totalCash:"Total Cash",totalBank:"Total Bank",totalAvailable:"Total Available",noAccounts:"No accounts found",saved:"Account saved",deposited:"Deposit recorded",withdrawn:"Withdrawal recorded",transferred:"Transfer completed",types:{cash:"Cash",bank:"Bank",capital:"Capital"},txnTypes:{sale_payment:"Sale Payment",purchase_payment:"Purchase Payment",customer_payment:"Customer Payment",supplier_payment:"Supplier Payment",expense:"Expense",transfer_in:"Transfer In",transfer_out:"Transfer Out",deposit:"Deposit",withdrawal:"Withdrawal",opening:"Opening Balance"}},expenses:{title:"Expenses",add:"Add Expense",category:"Category",account:"Paid From",amount:"Amount",description:"Description",date:"Expense Date",noExpenses:"No expenses found",saved:"Expense recorded"},reports:{title:"Reports",profitLoss:"Profit & Loss",salesReport:"Sales Report",purchaseReport:"Purchase Report",stockReport:"Stock Report",expenseReport:"Expense Report",dateRange:"Date Range",generate:"Generate Report",totalSales:"Total Sales",totalPurchases:"Total Purchases",totalExpenses:"Total Expenses",grossProfit:"Gross Profit",netProfit:"Net Profit",grossMargin:"Gross Margin",netMargin:"Net Margin",income:"Income",cogs:"Cost of Goods Sold",expensesByCategory:"Expenses by Category",noData:"No data for this period"},users:{title:"User Management",add:"Add User",edit:"Edit User",username:"Username",fullName:"Full Name",password:"Password",role:"Role",lastLogin:"Last Login",isActive:"Active",resetPassword:"Reset Password",newPassword:"New Password",saved:"User saved",passwordReset:"Password reset successfully",roles:{admin:"Administrator",manager:"Manager",cashier:"Cashier"},roleDescriptions:{admin:"Full access to all features",manager:"Manage operations, no user management",cashier:"POS and basic operations"},deactivateConfirm:"Deactivate this user?",noUsers:"No users found"},settings:{title:"Settings",company:"Company Information",companyName:"Company Name",address:"Address",phone:"Phone",email:"Email",language:"Language",currency:"Currency Symbol",saved:"Settings saved",invoiceSettings:"Invoice Settings",invoicePrefix:"Invoice Prefix"},confirm:{title:"Are you sure?",irreversible:"This action cannot be undone.",deleteItem:"Delete this item? This cannot be undone.",voidSale:"Void this sale? Stock will be restored and this cannot be undone.",logout:"You will be logged out of the system."},toast:{success:"Success",error:"Error",warning:"Warning",info:"Info",networkError:"Network error. Please check your connection.",serverError:"Server error. Please try again.",unauthorized:"Session expired. Please login again.",forbidden:"You do not have permission to perform this action."},validation:{required:"{field} is required",minLength:"{field} must be at least {min} characters",maxLength:"{field} must be at most {max} characters",numeric:"{field} must be a valid number",positive:"{field} must be a positive number",email:"Enter a valid email address",passwordMismatch:"Passwords do not match"},table:{noResults:"No results found",showing:"Showing {from}–{to} of {total}",rowsPerPage:"Per page",prev:"Previous",next:"Next"}},ye={app:{name:"কোরট্রেড ERP",company:"ইসলাম এন্টারপ্রাইজ",loading:"লোড হচ্ছে…",saving:"সংরক্ষণ হচ্ছে…",deleting:"মুছে ফেলা হচ্ছে…",error:"একটি সমস্যা হয়েছে",retry:"আবার চেষ্টা করুন",back:"পেছনে",close:"বন্ধ করুন",cancel:"বাতিল",confirm:"নিশ্চিত করুন",save:"সংরক্ষণ করুন",delete:"মুছুন",edit:"সম্পাদনা",add:"যোগ করুন",view:"দেখুন",print:"প্রিন্ট করুন",export:"CSV এক্সপোর্ট",import:"CSV ইমপোর্ট",search:"খুঁজুন…",filter:"ফিল্টার",clear:"মুছুন",submit:"জমা দিন",update:"আপডেট",noData:"কোনো তথ্য পাওয়া যায়নি",selectOption:"বেছে নিন…",actions:"কার্যক্রম",status:"অবস্থা",active:"সক্রিয়",inactive:"নিষ্ক্রিয়",yes:"হ্যাঁ",no:"না",all:"সব",today:"আজকের",thisMonth:"এই মাসের",custom:"কাস্টম তারিখ",from:"থেকে",to:"পর্যন্ত",date:"তারিখ",notes:"মন্তব্য",optional:"ঐচ্ছিক",required:"আবশ্যক",total:"মোট",subtotal:"উপমোট",discount:"ছাড়",paid:"পরিশোধিত",due:"বাকি",balance:"ব্যালেন্স"},auth:{login:"লগইন",logout:"লগআউট",username:"ব্যবহারকারীর নাম",password:"পাসওয়ার্ড",loginBtn:"ERP-তে লগইন করুন",loggingIn:"লগইন হচ্ছে…",logoutConfirm:"আপনি কি সত্যিই লগআউট করতে চান?",changePassword:"পাসওয়ার্ড পরিবর্তন",currentPassword:"বর্তমান পাসওয়ার্ড",newPassword:"নতুন পাসওয়ার্ড",confirmPassword:"পাসওয়ার্ড নিশ্চিত করুন",passwordChanged:"পাসওয়ার্ড সফলভাবে পরিবর্তিত হয়েছে",invalidCredentials:"ভুল ব্যবহারকারীর নাম বা পাসওয়ার্ড",sessionExpired:"সেশন শেষ হয়েছে। আবার লগইন করুন।",welcome:"স্বাগতম"},nav:{dashboard:"ড্যাশবোর্ড",pos:"পিওএস",sales:"বিক্রয়",purchases:"ক্রয়",products:"পণ্য",inventory:"স্টক",customers:"কাস্টমার",suppliers:"সাপ্লায়ার",payments:"পেমেন্ট",accounts:"হিসাব",expenses:"খরচ",reports:"রিপোর্ট",users:"ব্যবহারকারী",settings:"সেটিংস",backup:"ব্যাকআপ",customerPayments:"কাস্টমারের পেমেন্ট",supplierPayments:"সাপ্লায়ারের পেমেন্ট"},dashboard:{title:"ড্যাশবোর্ড",todaySales:"আজকের বিক্রয়",todayPurchases:"আজকের ক্রয়",todayExpenses:"আজকের খরচ",todayProfit:"আজকের লাভ",paymentsReceived:"গৃহীত পেমেন্ট",customerDue:"কাস্টমারের বাকি",supplierDue:"সাপ্লায়ারের বাকি",cashBalance:"নগদ ব্যালেন্স",bankBalance:"ব্যাংক ব্যালেন্স",totalAvailable:"মোট ক্যাশ",lowStockAlert:"স্বল্প স্টক সতর্কতা",recentSales:"সাম্প্রতিক বিক্রয়",quickActions:"দ্রুত কার্যক্রম",salesTrend:"বিক্রয়ের ধারা (৩০ দিন)",lowStockItems:"{n}টি পণ্যের স্টক কম",viewLowStock:"স্বল্প স্টক দেখুন",noRecentSales:"আজ কোনো বিক্রয় নেই"},quick:{newSale:"নতুন বিক্রয়",newPurchase:"নতুন ক্রয়",receivePayment:"কাস্টমারের টাকা গ্রহণ",paySupplier:"সাপ্লায়ারকে পেমেন্ট",addExpense:"খরচ যোগ করুন",addProduct:"পণ্য যোগ করুন",addCustomer:"কাস্টমার যোগ করুন"},pos:{title:"পয়েন্ট অব সেল",searchProduct:"পণ্যের নাম বা কোড দিয়ে খুঁজুন…",cart:"কার্ট",emptyCart:"কার্ট খালি। বিক্রয় শুরু করতে পণ্য যোগ করুন।",product:"পণ্য",qty:"পরিমাণ",unit:"একক",unitPrice:"একক মূল্য",itemDiscount:"পণ্য ছাড়",itemTotal:"মোট",removeItem:"পণ্য সরান",clearCart:"কার্ট খালি করুন",clearCartConfirm:"কার্ট খালি করতে চান?",orderSummary:"অর্ডার সারসংক্ষেপ",saleType:"বিক্রয়ের ধরন",cashSale:"নগদ বিক্রয়",creditSale:"বাকি বিক্রয়",wholesaleSale:"পাইকারি",selectCustomer:"কাস্টমার বেছে নিন",paymentAccount:"পেমেন্ট হিসাব",amountPaid:"পরিশোধের পরিমাণ",changeDue:"ফেরত",completeSale:"বিক্রয় সম্পন্ন করুন",completingLoading:"প্রক্রিয়া হচ্ছে…",saleSuccess:"বিক্রয় সফলভাবে সম্পন্ন হয়েছে",invoiceNo:"ইনভয়েস",printReceipt:"রসিদ প্রিন্ট",newSale:"নতুন বিক্রয়",insufficientStock:"অপর্যাপ্ত স্টক:",available:"পাওয়া যাচ্ছে",customerRequired:"বাকি বিক্রয়ের জন্য কাস্টমার বেছে নিন",accountRequired:"পেমেন্ট হিসাব বেছে নিন",itemsRequired:"অন্তত একটি পণ্য যোগ করুন",unitPriceRequired:"সব পণ্যের একক মূল্য দিন"},products:{title:"পণ্য",add:"পণ্য যোগ করুন",edit:"পণ্য সম্পাদনা",delete:"পণ্য নিষ্ক্রিয় করুন",deleteConfirm:"এই পণ্যটি নিষ্ক্রিয় করবেন? POS-এ দেখাবে না।",name:"পণ্যের নাম",nameBn:"পণ্যের নাম (বাংলা)",sku:"কোড / SKU",category:"বিভাগ",brand:"ব্র্যান্ড",size:"সাইজ",unit:"একক",retailPrice:"খুচরা মূল্য",wholesalePrice:"পাইকারি মূল্য",purchaseCost:"ক্রয় মূল্য",currentStock:"বর্তমান স্টক",openingStock:"প্রারম্ভিক স্টক",lowStockAlert:"স্বল্প স্টক সীমা",isActive:"সক্রিয়",notes:"মন্তব্য",basicInfo:"মূল তথ্য",pricing:"মূল্য",inventory:"স্টক",saved:"পণ্য সফলভাবে সংরক্ষিত হয়েছে",noProducts:"কোনো পণ্য পাওয়া যায়নি",lowStockBadge:"স্বল্প স্টক",searchPlaceholder:"নাম, কোড, ব্র্যান্ড দিয়ে খুঁজুন…",filterCategory:"বিভাগ অনুযায়ী ফিল্টার",showLowStock:"শুধু স্বল্প স্টক"},categories:{title:"বিভাগ",add:"বিভাগ যোগ করুন",edit:"বিভাগ সম্পাদনা",name:"বিভাগের নাম",nameBn:"বিভাগের নাম (বাংলা)",slug:"স্লাগ",sortOrder:"ক্রম",saved:"বিভাগ সংরক্ষিত হয়েছে",deleted:"বিভাগ মুছে ফেলা হয়েছে",hasProducts:"এই বিভাগে পণ্য আছে। বরং নিষ্ক্রিয় করুন।"},inventory:{title:"স্টক ব্যবস্থাপনা",movements:"স্টক চলাচল",adjust:"স্টক সমন্বয়",adjustIn:"স্টক বাড়ান (যোগ)",adjustOut:"স্টক কমান (বাদ)",lowStock:"স্বল্প স্টক",summary:"স্টক সারসংক্ষেপ",adjustConfirm:"স্টক সমন্বয় নিশ্চিত করুন?",product:"পণ্য",movementType:"ধরন",qty:"পরিমাণ",balanceAfter:"পরবর্তী স্টক",reference:"রেফারেন্স",reason:"কারণ",adjustSuccess:"স্টক সফলভাবে সমন্বিত হয়েছে",movementTypes:{purchase:"ক্রয়",sale:"বিক্রয়",return_in:"ফেরত আসা",return_out:"ফেরত পাঠানো",adjustment_in:"সমন্বয় (বাড়ানো)",adjustment_out:"সমন্বয় (কমানো)",opening:"প্রারম্ভিক স্টক"},stockValue:"স্টকের মূল্য",costValue:"ক্রয় মূল্যে",retailValue:"বিক্রয় মূল্যে"},customers:{title:"কাস্টমার",add:"কাস্টমার যোগ করুন",edit:"কাস্টমার সম্পাদনা",delete:"কাস্টমার মুছুন",deleteConfirm:"এই কাস্টমারকে মুছে ফেলবেন? এটি পূর্বাবস্থায় আনা যাবে না।",name:"কাস্টমারের নাম",phone:"ফোন",address:"ঠিকানা",creditLimit:"ক্রেডিট সীমা",currentDue:"বর্তমান বাকি",lastTransaction:"শেষ লেনদেন",ledger:"হিসাব খাতা",receivePayment:"পেমেন্ট গ্রহণ",newSale:"নতুন বিক্রয়",saved:"কাস্টমার সংরক্ষিত হয়েছে",noCustomers:"কোনো কাস্টমার পাওয়া যায়নি",searchPlaceholder:"নাম বা ফোন দিয়ে খুঁজুন…"},suppliers:{title:"সাপ্লায়ার",add:"সাপ্লায়ার যোগ করুন",edit:"সাপ্লায়ার সম্পাদনা",delete:"সাপ্লায়ার মুছুন",deleteConfirm:"এই সাপ্লায়ারকে মুছে ফেলবেন?",name:"সাপ্লায়ারের নাম",phone:"ফোন",address:"ঠিকানা",currentDue:"বর্তমান পাওনা",lastTransaction:"শেষ লেনদেন",ledger:"হিসাব খাতা",makePayment:"পেমেন্ট করুন",newPurchase:"নতুন ক্রয়",saved:"সাপ্লায়ার সংরক্ষিত হয়েছে",noSuppliers:"কোনো সাপ্লায়ার পাওয়া যায়নি"},ledger:{title:"হিসাব খাতা",date:"তারিখ",description:"বিবরণ",debit:"ডেবিট",credit:"ক্রেডিট",balance:"ব্যালেন্স",openingBalance:"প্রারম্ভিক ব্যালেন্স",closingBalance:"সমাপনী ব্যালেন্স",noEntries:"এই সময়ের জন্য কোনো লেনদেন নেই"},sales:{title:"বিক্রয়",invoice:"ইনভয়েস নম্বর",date:"বিক্রয়ের তারিখ",customer:"কাস্টমার",type:"ধরন",total:"মোট",paid:"পরিশোধিত",due:"বাকি",status:"অবস্থা",void:"বিক্রয় বাতিল",voidConfirm:"এই বিক্রয় বাতিল করবেন? স্টক ফেরত আসবে।",voidReason:"বাতিলের কারণ",voided:"বাতিল",completed:"সম্পন্ন",viewInvoice:"ইনভয়েস দেখুন",noSales:"কোনো বিক্রয় পাওয়া যায়নি",types:{cash:"নগদ",credit:"বাকি",wholesale:"পাইকারি"}},purchases:{title:"ক্রয়",add:"নতুন ক্রয়",invoice:"ক্রয় নম্বর",date:"ক্রয়ের তারিখ",supplier:"সাপ্লায়ার",total:"মোট",paid:"পরিশোধিত",due:"বাকি",noPurchases:"কোনো ক্রয় পাওয়া যায়নি",saved:"ক্রয় সফলভাবে সংরক্ষিত হয়েছে"},payments:{customerTitle:"কাস্টমারের পেমেন্ট",supplierTitle:"সাপ্লায়ারের পেমেন্ট",receivePayment:"পেমেন্ট গ্রহণ করুন",makePayment:"পেমেন্ট করুন",customer:"কাস্টমার",supplier:"সাপ্লায়ার",amount:"পরিমাণ",method:"পেমেন্টের মাধ্যম",reference:"রেফারেন্স নম্বর",account:"হিসাব",paymentDate:"পেমেন্টের তারিখ",recorded:"পেমেন্ট সফলভাবে রেকর্ড হয়েছে",methods:{cash:"নগদ",bank_transfer:"ব্যাংক ট্রান্সফার",cheque:"চেক",mobile_banking:"মোবাইল ব্যাংকিং"}},accounts:{title:"হিসাব",add:"হিসাব যোগ করুন",edit:"হিসাব সম্পাদনা",name:"হিসাবের নাম",type:"হিসাবের ধরন",balance:"ব্যালেন্স",statement:"স্টেটমেন্ট",deposit:"জমা",withdraw:"উত্তোলন",transfer:"ট্রান্সফার",transferTo:"যেখানে পাঠাবেন",amount:"পরিমাণ",description:"বিবরণ",totalCash:"মোট নগদ",totalBank:"মোট ব্যাংক",totalAvailable:"মোট উপলব্ধ",noAccounts:"কোনো হিসাব পাওয়া যায়নি",saved:"হিসাব সংরক্ষিত হয়েছে",deposited:"জমা রেকর্ড হয়েছে",withdrawn:"উত্তোলন রেকর্ড হয়েছে",transferred:"ট্রান্সফার সম্পন্ন হয়েছে",types:{cash:"নগদ",bank:"ব্যাংক",capital:"মূলধন"},txnTypes:{sale_payment:"বিক্রয় পেমেন্ট",purchase_payment:"ক্রয় পেমেন্ট",customer_payment:"কাস্টমার পেমেন্ট",supplier_payment:"সাপ্লায়ার পেমেন্ট",expense:"খরচ",transfer_in:"ট্রান্সফার গ্রহণ",transfer_out:"ট্রান্সফার প্রেরণ",deposit:"জমা",withdrawal:"উত্তোলন",opening:"প্রারম্ভিক ব্যালেন্স"}},expenses:{title:"খরচ",add:"খরচ যোগ করুন",category:"বিভাগ",account:"যে হিসাব থেকে",amount:"পরিমাণ",description:"বিবরণ",date:"খরচের তারিখ",noExpenses:"কোনো খরচ পাওয়া যায়নি",saved:"খরচ রেকর্ড হয়েছে"},reports:{title:"রিপোর্ট",profitLoss:"লাভ ও ক্ষতি",salesReport:"বিক্রয় রিপোর্ট",purchaseReport:"ক্রয় রিপোর্ট",stockReport:"স্টক রিপোর্ট",expenseReport:"খরচের রিপোর্ট",dateRange:"তারিখের পরিসর",generate:"রিপোর্ট তৈরি করুন",totalSales:"মোট বিক্রয়",totalPurchases:"মোট ক্রয়",totalExpenses:"মোট খরচ",grossProfit:"স্থূল লাভ",netProfit:"নিট লাভ",grossMargin:"স্থূল মার্জিন",netMargin:"নিট মার্জিন",income:"আয়",cogs:"পণ্যের ক্রয় মূল্য",expensesByCategory:"বিভাগ অনুযায়ী খরচ",noData:"এই সময়ের জন্য কোনো তথ্য নেই"},users:{title:"ব্যবহারকারী",add:"ব্যবহারকারী যোগ করুন",edit:"ব্যবহারকারী সম্পাদনা",username:"ব্যবহারকারীর নাম",fullName:"পুরো নাম",password:"পাসওয়ার্ড",role:"ভূমিকা",lastLogin:"শেষ লগইন",isActive:"সক্রিয়",resetPassword:"পাসওয়ার্ড রিসেট",newPassword:"নতুন পাসওয়ার্ড",saved:"ব্যবহারকারী সংরক্ষিত হয়েছে",passwordReset:"পাসওয়ার্ড সফলভাবে রিসেট হয়েছে",roles:{admin:"প্রশাসক",manager:"ম্যানেজার",cashier:"ক্যাশিয়ার"},roleDescriptions:{admin:"সব বিষয়ে সম্পূর্ণ অ্যাক্সেস",manager:"ব্যবহারকারী ব্যবস্থাপনা ছাড়া সব",cashier:"POS এবং সাধারণ কার্যক্রম"},deactivateConfirm:"এই ব্যবহারকারীকে নিষ্ক্রিয় করবেন?",noUsers:"কোনো ব্যবহারকারী পাওয়া যায়নি"},settings:{title:"সেটিংস",company:"প্রতিষ্ঠানের তথ্য",companyName:"প্রতিষ্ঠানের নাম",address:"ঠিকানা",phone:"ফোন",email:"ইমেইল",language:"ভাষা",currency:"মুদ্রার প্রতীক",saved:"সেটিংস সংরক্ষিত হয়েছে",invoiceSettings:"ইনভয়েস সেটিংস",invoicePrefix:"ইনভয়েস উপসর্গ"},confirm:{title:"আপনি কি নিশ্চিত?",irreversible:"এই কাজটি পূর্বাবস্থায় আনা যাবে না।",deleteItem:"এই আইটেমটি মুছবেন? এটি পূর্বাবস্থায় আনা যাবে না।",voidSale:"এই বিক্রয় বাতিল করবেন? স্টক ফেরত আসবে এবং এটি পূর্বাবস্থায় আনা যাবে না।",logout:"আপনাকে সিস্টেম থেকে লগআউট করা হবে।"},toast:{success:"সফল",error:"সমস্যা",warning:"সতর্কতা",info:"তথ্য",networkError:"নেটওয়ার্ক সমস্যা। সংযোগ পরীক্ষা করুন।",serverError:"সার্ভার সমস্যা। আবার চেষ্টা করুন।",unauthorized:"সেশন শেষ হয়েছে। আবার লগইন করুন।",forbidden:"এই কাজ করার অনুমতি নেই।"},validation:{required:"{field} আবশ্যক",minLength:"{field} কমপক্ষে {min} অক্ষরের হতে হবে",maxLength:"{field} সর্বোচ্চ {max} অক্ষরের হতে হবে",numeric:"{field} সঠিক সংখ্যা হতে হবে",positive:"{field} ধনাত্মক সংখ্যা হতে হবে",email:"সঠিক ইমেইল ঠিকানা দিন",passwordMismatch:"পাসওয়ার্ড মিলছে না"},table:{noResults:"কোনো ফলাফল পাওয়া যায়নি",showing:"{from}–{to} দেখাচ্ছে (মোট {total})",rowsPerPage:"প্রতি পাতায়",prev:"আগে",next:"পরে"}},it={en:be,bn:ye};let U=localStorage.getItem("ct_lang")||"en";const Pt=new Set;function t(e,s={}){const n=it[U]||it.en,a=e.split(".");let o=n;for(const r of a)if(o&&typeof o=="object")o=o[r];else{o=void 0;break}if(o===void 0){o=it.en;for(const r of a)if(o&&typeof o=="object")o=o[r];else{o=void 0;break}}return o===void 0||typeof o=="object"?e:String(o).replace(/\{(\w+)\}/g,(r,i)=>s[i]!==void 0?s[i]:`{${i}}`)}function at(){return U}function bt(e){it[e]&&(U=e,localStorage.setItem("ct_lang",e),document.documentElement.lang=e,document.documentElement.setAttribute("data-lang",e),Pt.forEach(s=>s(e)))}function ge(e){return Pt.add(e),()=>Pt.delete(e)}function c(e){return"৳ "+(parseFloat(e)||0).toLocaleString("en-IN",{minimumFractionDigits:2,maximumFractionDigits:2})}function L(e){if(!e)return"—";try{return new Date(e).toLocaleDateString(U==="bn"?"bn-BD":"en-GB",{day:"2-digit",month:"short",year:"numeric"})}catch{return e}}function Ct(e){if(!e)return"—";try{return new Date(e).toLocaleString(U==="bn"?"bn-BD":"en-GB",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return e}}document.documentElement.lang=U;document.documentElement.setAttribute("data-lang",U);const O={user:null,settings:{},isLoading:!1},jt=new Map;function Ht(e,s){O[e]=s,(jt.get(e)||[]).forEach(n=>n(s)),(jt.get("*")||[]).forEach(n=>n({key:e,value:s}))}const I={get user(){return O.user},set user(e){Ht("user",e)},get settings(){return O.settings},set settings(e){Ht("settings",e)},isAuthenticated:()=>!!O.user,isAdmin:()=>{var e;return((e=O.user)==null?void 0:e.role)==="admin"},isManager:()=>{var e;return["admin","manager"].includes((e=O.user)==null?void 0:e.role)},isCashier:()=>!!O.user},he="/api";class zt extends Error{constructor(s,n,a){super(s),this.status=n,this.data=a}}async function Z(e,s,n=null){const a=localStorage.getItem("ct_token"),o={"Content-Type":"application/json"};a&&(o.Authorization=`Bearer ${a}`);const r={method:e,credentials:"include",headers:o};n!==null&&(r.body=JSON.stringify(n));let i;try{i=await fetch(`${he}${s}`,r)}catch{throw new zt("Network error — check your connection",0,null)}const d=(i.headers.get("content-type")||"").includes("json")?await i.json():await i.text();if(!i.ok){const p=(d==null?void 0:d.error)||(d==null?void 0:d.message)||`HTTP ${i.status}`;throw new zt(p,i.status,d)}return d}const m={get:e=>Z("GET",e),post:(e,s)=>Z("POST",e,s),put:(e,s)=>Z("PUT",e,s),patch:(e,s)=>Z("PATCH",e,s),delete:e=>Z("DELETE",e)},ft={login:(e,s)=>m.post("/auth/login",{username:e,password:s}),logout:()=>m.post("/auth/logout"),me:()=>m.get("/auth/me"),changePassword:e=>m.post("/auth/change-password",e)},J={list:()=>m.get("/users"),get:e=>m.get(`/users/${e}`),create:e=>m.post("/users",e),update:(e,s)=>m.put(`/users/${e}`,s),resetPassword:(e,s)=>m.post(`/users/${e}/reset-password`,{new_password:s})},st={list:()=>m.get("/categories"),create:e=>m.post("/categories",e),update:(e,s)=>m.put(`/categories/${e}`,s),delete:e=>m.delete(`/categories/${e}`)},H={list:(e={})=>m.get("/products?"+new URLSearchParams(e)),search:e=>m.get(`/products/search?q=${encodeURIComponent(e)}`),get:e=>m.get(`/products/${e}`),create:e=>m.post("/products",e),update:(e,s)=>m.put(`/products/${e}`,s),delete:e=>m.delete(`/products/${e}`)},B={list:(e={})=>m.get("/customers?"+new URLSearchParams(e)),get:e=>m.get(`/customers/${e}`),ledger:(e,s={})=>m.get(`/customers/${e}/ledger?`+new URLSearchParams(s)),create:e=>m.post("/customers",e),update:(e,s)=>m.put(`/customers/${e}`,s),delete:e=>m.delete(`/customers/${e}`)},A={list:(e={})=>m.get("/suppliers?"+new URLSearchParams(e)),get:e=>m.get(`/suppliers/${e}`),ledger:(e,s={})=>m.get(`/suppliers/${e}/ledger?`+new URLSearchParams(s)),create:e=>m.post("/suppliers",e),update:(e,s)=>m.put(`/suppliers/${e}`,s),delete:e=>m.delete(`/suppliers/${e}`)},$t={list:(e={})=>m.get("/sales?"+new URLSearchParams(e)),get:e=>m.get(`/sales/${e}`),create:e=>m.post("/sales",e),void:(e,s)=>m.post(`/sales/${e}/void`,{void_reason:s})},Bt={list:(e={})=>m.get("/purchases?"+new URLSearchParams(e)),get:e=>m.get(`/purchases/${e}`),create:e=>m.post("/purchases",e)},Q={customerList:(e={})=>m.get("/payments/customers?"+new URLSearchParams(e)),customerCreate:e=>m.post("/payments/customers",e),supplierList:(e={})=>m.get("/payments/suppliers?"+new URLSearchParams(e)),supplierCreate:e=>m.post("/payments/suppliers",e)},T={list:()=>m.get("/accounts"),get:e=>m.get(`/accounts/${e}`),statement:(e,s={})=>m.get(`/accounts/${e}/statement?`+new URLSearchParams(s)),create:e=>m.post("/accounts",e),update:(e,s)=>m.put(`/accounts/${e}`,s),deposit:(e,s)=>m.post(`/accounts/${e}/deposit`,s),withdraw:(e,s)=>m.post(`/accounts/${e}/withdraw`,s),transfer:(e,s)=>m.post(`/accounts/${e}/transfer`,s)},wt={movements:(e={})=>m.get("/inventory/movements?"+new URLSearchParams(e)),lowStock:()=>m.get("/inventory/low-stock"),summary:()=>m.get("/inventory/summary"),adjust:e=>m.post("/inventory/adjust",e)},Tt={list:(e={})=>m.get("/expenses?"+new URLSearchParams(e)),categories:()=>m.get("/expenses/categories"),create:e=>m.post("/expenses",e),update:(e,s)=>m.put(`/expenses/${e}`,s)},lt={dashboard:()=>m.get("/reports/dashboard"),profitLoss:e=>m.get("/reports/profit-loss?"+new URLSearchParams(e)),sales:e=>m.get("/reports/sales?"+new URLSearchParams(e)),purchases:e=>m.get("/reports/purchases?"+new URLSearchParams(e))},Qt={get:()=>m.get("/settings"),update:e=>m.put("/settings",e)},Ot={export:()=>m.get("/backup/export"),import:e=>m.post("/backup/import",{backup:e})};function w({title:e,body:s,size:n="md",footer:a=[],closable:o=!0}){var p;const r=document.createElement("div");r.className="modal-overlay",r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true"),r.setAttribute("aria-label",e);const i=a.map((u,v)=>`
  ...
  `;const l=r.querySelector(".modal-body");typeof s=="string"?l.innerHTML=s:l.appendChild(s);const d=()=>{r.style.animation="fadeIn 0.15s ease reverse",setTimeout(()=>r.remove(),150)};return o&&((p=r.querySelector(".modal-close"))==null||p.addEventListener("click",d),r.addEventListener("click",u=>{u.target===r&&d()})),document.addEventListener("keydown",function u(v){v.key==="Escape"&&o&&(d(),document.removeEventListener("keydown",u))}),a.forEach((u,v)=>{var b;(b=r.querySelector(`[data-action="${v}"]`))==null||b.addEventListener("click",()=>{var f;(f=u.action)==null||f.call(u,{close:d})})}),document.body.appendChild(r),setTimeout(()=>{const u=r.querySelector(".modal-footer .btn")||r.querySelector(".modal-close");u==null||u.focus()},50),{el:r,close:d}}function M({title:e=t("confirm.title"),message:s,confirmLabel:n=t("app.confirm"),cancelLabel:a=t("app.cancel"),type:o="danger",details:r}){return new Promise(i=>{const l=`
    ...
    `,{close:d}=w({title:e,body:l,size:"sm",closable:!0,footer:[{label:a,class:"btn-secondary",action:({close:u})=>{u(),i(!1)}},{label:n,class:o==="danger"?"btn-danger":"btn-primary",action:({close:u})=>{u(),i(!0)}}]}),p=new MutationObserver(()=>{document.body.contains(d)||(i(!1),p.disconnect())})})}let G;function fe(){return G||(G=document.createElement("div"),G.className="toast-container",G.setAttribute("aria-live","polite"),document.body.appendChild(G)),G}const $e={success:"✓",error:"✕",warning:"⚠",info:"ℹ"};function Yt(e,s,n=4e3){const a=fe(),o=document.createElement("div");o.className=`toast toast-${e}`,o.setAttribute("role","alert"),o.innerHTML=`
    ...
    <div class="topbar" id="topbar">
      ...
      <div class="topbar-right">
        <div class="lang-switcher" role="group" aria-label="Language">
          <button class="lang-btn ${at()==="en"?"active":""}" id="lang-en" data-lang="en">EN</button>
          <button class="lang-btn ${at()==="bn"?"active":""}" id="lang-bn" data-lang="bn">বাং</button>
        </div>
        <div class="user-menu">
  ...
  `,qt(),_e(),Ft(),ge(()=>{qt(),document.getElementById("shell-app-name").textContent=t("app.name"),document.getElementById("shell-company").textContent=t("app.company"),document.getElementById("logout-label").textContent=t("auth.logout"),Ft()})}function qt(){const e=document.getElementById("sidebar-nav");if(!e)return;const s=window.location.hash.slice(1)||"/",n=I.user;let a="";for(const o of we){o.label()&&(a+=`<div class="sidebar-section-label">${o.label()}</div>`);for(const r of o.items){const i=s===r.path||r.path!=="/"&&s.startsWith(r.path);a+=`
      ...
      `}}e.innerHTML=a,e.querySelectorAll(".nav-item").forEach(o=>{o.addEventListener("click",()=>{C(o.dataset.path),Xt()}),o.addEventListener("keydown",r=>{r.key==="Enter"&&o.click()})})}function Ft(){const e=I.user;if(!e)return;const s=document.getElementById("user-avatar"),n=document.getElementById("user-name"),a=document.getElementById("sidebar-user-info"),o=e.full_name.split(" ").map(r=>r[0]).slice(0,2).join("").toUpperCase();s&&(s.textContent=o),n&&(n.textContent=e.full_name),a&&(a.textContent=`${e.full_name} (${e.role})`)}function _e(){var e,s,n,a,o;(e=document.getElementById("lang-en"))==null||e.addEventListener("click",()=>Nt("en")),(s=document.getElementById("lang-bn"))==null||s.addEventListener("click",()=>Nt("bn")),(n=document.getElementById("mobile-menu-btn"))==null||n.addEventListener("click",ke),(a=document.getElementById("mobile-overlay"))==null||a.addEventListener("click",Xt),(o=document.getElementById("logout-btn"))==null||o.addEventListener("click",async()=>{await M({title:t("auth.logout"),message:t("confirm.logout"),type:"warning",confirmLabel:t("auth.logout")})&&(await ft.logout().catch(()=>{}),localStorage.removeItem("ct_token"),I.user=null,C("/login"))}),window.addEventListener("hashchange",()=>qt())}function Nt(e){bt(e),document.querySelectorAll(".lang-btn").forEach(s=>{s.classList.toggle("active",s.dataset.lang===e)})}function ke(){var e,s;(e=document.getElementById("sidebar"))==null||e.classList.toggle("mobile-open"),(s=document.getElementById("mobile-overlay"))==null||s.classList.toggle("active")}function Xt(){var e,s;(e=document.getElementById("sidebar"))==null||e.classList.remove("mobile-open"),(s=document.getElementById("mobile-overlay"))==null||s.classList.remove("active")}function k(e){const s=document.getElementById("topbar-title");s&&(s.textContent=e)}function Se(){return document.getElementById("page-outlet")}async function It(e){var s,n,a,o,r,i;e.innerHTML=`
        ...
        <div style="background:#1e293b; border:1px solid #334155; border-radius:1rem;
          ...
          <div style="display:flex; justify-content:flex-end; margin-bottom:1.5rem;">
            <div class="lang-switcher">
              <button class="lang-btn ${at()==="en"?"active":""}" data-lang="en" id="login-lang-en">EN</button>
              <button class="lang-btn ${at()==="bn"?"active":""}" data-lang="bn" id="login-lang-bn">বাং</button>
            </div>
          </div>
  ...
  `,(s=document.getElementById("login-lang-en"))==null||s.addEventListener("click",()=>{bt("en"),It(e)}),(n=document.getElementById("login-lang-bn"))==null||n.addEventListener("click",()=>{bt("bn"),It(e)}),(a=document.getElementById("toggle-password"))==null||a.addEventListener("click",()=>{const l=document.getElementById("login-password");l.type=l.type==="password"?"text":"password"}),(o=document.getElementById("login-form"))==null||o.addEventListener("submit",async l=>{l.preventDefault();const d=document.getElementById("login-btn"),p=document.getElementById("login-error"),u=document.getElementById("login-username").value.trim(),v=document.getElementById("login-password").value;if(!u||!v){p.textContent=t("auth.invalidCredentials"),p.style.display="block";return}d.classList.add("loading"),d.disabled=!0,d.textContent=t("auth.loggingIn"),p.style.display="none";try{const b=await ft.login(u,v);b.token&&localStorage.setItem("ct_token",b.token),I.user=b.user,C("/")}catch(b){p.textContent=b.message||t("auth.invalidCredentials"),p.style.display="block",d.classList.remove("loading"),d.disabled=!1,d.textContent=t("auth.loginBtn"),document.getElementById("login-password").value=""}}),(r=document.getElementById("login-username"))==null||r.focus(),(i=document.getElementById("initial-loader"))==null||i.remove()}async function Le(e){var s,n;k(t("dashboard.title")),e.innerHTML=`
  ...
  `,document.getElementById("dash-date").textContent=new Date().toLocaleDateString("en-GB",{weekday:"long",day:"numeric",month:"long",year:"numeric"}),document.querySelectorAll("[data-qa-path]").forEach(a=>{a.addEventListener("click",()=>C(a.dataset.qaPath))});try{const{today:a,customer_due:o,supplier_due:r,total_cash:i,total_bank:l,total_available:d,low_stock_count:p,recent_sales:u}=await lt.dashboard(),v=document.getElementById("stats-grid");v.innerHTML=`
      ${D(t("dashboard.todaySales"),c(a.sales),`${a.sale_count} ${t("nav.sales")}`,"#6366f1","💰")}
      ${D(t("dashboard.todayPurchases"),c(a.purchases),`${a.purchase_count} ${t("nav.purchases")}`,"#f59e0b","📦")}
      ${D(t("dashboard.todayExpenses"),c(a.expenses),"","#ef4444","💳")}
      ${D(t("dashboard.todayProfit"),c(a.profit),"",a.profit>=0?"#10b981":"#ef4444","📈")}
      ${D(t("dashboard.cashBalance"),c(i),"","#10b981","💵")}
      ${D(t("dashboard.bankBalance"),c(l),t("dashboard.totalAvailable")+": "+c(d),"#0ea5e9","🏦")}
      ${D(t("dashboard.customerDue"),c(o),"","#f59e0b","👥")}
      ${D(t("dashboard.supplierDue"),c(r),"","#ef4444","🏭")}
    `;const b=document.getElementById("recent-sales-card");b.innerHTML=`
      ...
      `}
    `,(s=document.getElementById("view-all-sales"))==null||s.addEventListener("click",()=>C("/sales"));const f=document.getElementById("low-stock-card");p===0?f.innerHTML=`
      ...
      `:(f.innerHTML=`
        <div class="card-header">
          <span class="card-title">${t("dashboard.lowStockAlert")}</span>
          <span class="badge badge-warning">${t("dashboard.lowStockItems").replace("{n}",p)}</span>
        </div>
        <div style="padding:1rem; text-align:center;">
          <div style="font-size:2rem; margin-bottom:0.5rem;">⚠️</div>
          <div style="font-weight:600; color:var(--color-warning); margin-bottom:1rem;">
            ${t("dashboard.lowStockItems").replace("{n}",p)}
          </div>
          <button class="btn btn-warning btn-sm" id="view-low-stock">${t("dashboard.viewLowStock")}</button>
        </div>
      `,(n=document.getElementById("view-low-stock"))==null||n.addEventListener("click",()=>C("/inventory?tab=low-stock")))}catch(a){h(a)}}function D(e,s,n,a,o){return`
  ...
  `).join("")}let _=[],Ut=[],Vt=[];async function Te(e){k(t("pos.title")),_=[],e.innerHTML=`
  ...
  `,await qe(),Ie()}async function qe(){try{const[e,s]=await Promise.all([B.list({limit:500}),T.list()]);Ut=e.customers||[],Vt=(s.accounts||[]).filter(o=>o.type!=="capital");const n=document.getElementById("pos-customer"),a=document.getElementById("pos-account");n&&Ut.forEach(o=>{const r=document.createElement("option");r.value=o.id,r.textContent=`${o.name}${o.phone?` (${o.phone})`:""} — ${t("app.due")}: ${c(o.balance)}`,n.appendChild(r)}),a&&Vt.forEach(o=>{const r=document.createElement("option");r.value=o.id,r.textContent=`${o.name} — ${c(o.balance)}`,o.is_default&&(r.selected=!0),a.appendChild(r)})}catch(e){h(e)}}function Ie(){var s,n,a,o,r,i;let e;(s=document.getElementById("pos-search"))==null||s.addEventListener("input",l=>{clearTimeout(e);const d=l.target.value.trim();if(d.length<1){At();return}e=setTimeout(()=>Ce(d),200)}),document.querySelectorAll(".sale-type-btn").forEach(l=>{l.addEventListener("click",()=>{document.querySelectorAll(".sale-type-btn").forEach(u=>{u.classList.remove("active","btn-primary","btn-warning","btn-secondary"),u.classList.add("btn-secondary")}),l.classList.add("active","btn-primary"),l.classList.remove("btn-secondary");const d=l.dataset.type,p=document.getElementById("customer-group");p&&(p.style.display=d==="credit"?"block":"none"),R()})}),(n=document.getElementById("type-cash"))==null||n.classList.add("btn-primary"),document.querySelectorAll(".sale-type-btn:not(#type-cash)").forEach(l=>l.classList.add("btn-secondary")),(a=document.getElementById("cart-discount"))==null||a.addEventListener("input",R),(o=document.getElementById("amount-paid"))==null||o.addEventListener("input",R),(r=document.getElementById("clear-cart-btn"))==null||r.addEventListener("click",async()=>{if(_.length===0)return;await M({message:t("pos.clearCartConfirm"),type:"warning"})&&(_=[],xt())}),(i=document.getElementById("complete-sale-btn"))==null||i.addEventListener("click",Ae)}async function Ce(e){const s=document.getElementById("pos-results");if(s){s.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>';try{const{products:n}=await H.search(e);if(!n.length){s.innerHTML=`
        <div class="empty-state">
          <div class="empty-state-icon">🔍</div>
    ...
    `).join(""),s.querySelectorAll(".pos-product-card").forEach(a=>{a.addEventListener("click",()=>{const o=JSON.parse(a.dataset.product);Be(o)})})}catch(n){h(n),At()}}}function At(){const e=document.getElementById("pos-results");e&&(e.innerHTML=`
    <div class="empty-state">
      <div class="empty-state-icon">🔍</div>
      <div class="empty-state-title">${t("pos.searchProduct")}</div>
    </div>
  `)}function Be(e){var a;const s=_.find(o=>o.product_id===e.id);if(s)s.qty=parseFloat(s.qty)+1;else{const r=(((a=document.querySelector(".sale-type-btn.active"))==null?void 0:a.dataset.type)||"cash")==="wholesale"?e.wholesale_price:e.retail_price;_.push({product_id:e.id,name:e.name,sku:e.sku,unit:e.unit,unit_price:parseFloat(r),qty:1,discount:0,max_stock:parseFloat(e.current_stock)})}xt();const n=document.getElementById("pos-search");n&&(n.value="",n.focus()),At()}function xt(){const e=document.getElementById("cart-items");if(document.getElementById("cart-empty"),!!e){if(_.length===0){e.innerHTML=`
      <div class="empty-state" id="cart-empty">
        <div class="empty-state-icon">🛒</div>
        <div class="empty-state-text">${t("pos.emptyCart")}</div>
      </div>
    `,R();return}e.innerHTML=_.map((s,n)=>`
  ...
  `).join(""),e.querySelectorAll(".item-qty").forEach(s=>{s.addEventListener("input",n=>{const a=parseInt(n.target.dataset.idx);_[a].qty=parseFloat(n.target.value)||0,kt(a),R()})}),e.querySelectorAll(".item-price").forEach(s=>{s.addEventListener("input",n=>{const a=parseInt(n.target.dataset.idx);_[a].unit_price=parseFloat(n.target.value)||0,kt(a),R()})}),e.querySelectorAll(".item-discount").forEach(s=>{s.addEventListener("input",n=>{const a=parseInt(n.target.dataset.idx);_[a].discount=parseFloat(n.target.value)||0,kt(a),R()})}),e.querySelectorAll(".item-remove").forEach(s=>{s.addEventListener("click",n=>{const a=parseInt(n.currentTarget.dataset.idx);_.splice(a,1),xt()})}),R()}}function kt(e){const s=_[e],n=Math.max(0,s.qty*s.unit_price-s.discount),a=document.getElementById(`item-total-${e}`);a&&(a.textContent=c(n))}function R(){var l,d;const e=_.reduce((p,u)=>p+Math.max(0,u.qty*u.unit_price-u.discount),0),s=parseFloat((l=document.getElementById("cart-discount"))==null?void 0:l.value)||0,n=Math.max(0,e-s),a=parseFloat((d=document.getElementById("amount-paid"))==null?void 0:d.value)||0,o=Math.max(0,a-n),r=Math.max(0,n-a),i=(p,u)=>{const v=document.getElementById(p);v&&(v.textContent=u)};i("summary-subtotal",c(e)),i("summary-total",c(n)),i("summary-change",c(o)),i("summary-due",c(r))}async function Ae(){var l,d,p,u,v,b,f;if(_.length===0){y(t("pos.itemsRequired"));return}for(const g of _){if(!g.unit_price||g.unit_price<=0){y(t("pos.unitPriceRequired"));return}if(!g.qty||g.qty<=0){y(`${t("pos.qty")} required`);return}}const e=((l=document.querySelector(".sale-type-btn.active"))==null?void 0:l.dataset.type)||"cash",s=(d=document.getElementById("pos-customer"))==null?void 0:d.value,n=(p=document.getElementById("pos-account"))==null?void 0:p.value;if(e==="credit"&&!s){y(t("pos.customerRequired"));return}if(!n&&e!=="credit"){y(t("pos.accountRequired"));return}const a=parseFloat((u=document.getElementById("cart-discount"))==null?void 0:u.value)||0,o=parseFloat((v=document.getElementById("amount-paid"))==null?void 0:v.value)||0,r=(b=document.getElementById("pos-notes"))==null?void 0:b.value;for(const g of _)if(g.qty>g.max_stock){y(`${t("pos.insufficientStock")} "${g.name}". ${t("pos.available")}: ${g.max_stock} ${g.unit}`);return}const i=document.getElementById("complete-sale-btn");i&&(i.disabled=!0,i.textContent=t("pos.completingLoading"));try{const g={sale_type:e,customer_id:s||void 0,account_id:n||void 0,items:_.map(ot=>({product_id:ot.product_id,qty:ot.qty,unit_price:ot.unit_price,discount:ot.discount})),discount:a,paid:o,notes:r},{sale:V,message:_t}=await $t.create(g);$(`${t("pos.saleSuccess")} · ${t("pos.invoiceNo")}: ${V.invoice_no}`),_=[],xt(),document.getElementById("cart-discount")&&(document.getElementById("cart-discount").value="0"),document.getElementById("amount-paid")&&(document.getElementById("amount-paid").value="0"),document.getElementById("pos-notes")&&(document.getElementById("pos-notes").value=""),(f=document.getElementById("pos-search"))==null||f.focus()}catch(g){y(g.message||t("toast.serverError"))}finally{i&&(i.disabled=!1,i.textContent=`✓ ${t("pos.completeSale")}`)}}let St=[],Zt=[],K=1,Gt=0,ct={search:"",category_id:"",low_stock:""};async function Me(e){k(t("products.title")),e.innerHTML=`
    <div class="page-header">
  ...
  `,await De(),await N(),Re()}async function De(){try{const{categories:e}=await st.list();Zt=e;const s=document.getElementById("category-filter");e.forEach(n=>{const a=document.createElement("option");a.value=n.id,a.textContent=n.name,s==null||s.appendChild(a)})}catch{}}async function N(){const e=document.getElementById("products-tbody");e&&(e.innerHTML='<tr><td colspan="8"><div class="loading-spinner"><div class="spinner"></div></div></td></tr>');try{const s={page:K,limit:50,...ct};Object.keys(s).forEach(a=>{s[a]||delete s[a]});const n=await H.list(s);if(St=n.products,Gt=n.total,!e)return;if(!St.length){e.innerHTML=`<tr><td colspan="8"><div class="empty-state"><div class="empty-state-icon">📦</div><div class="empty-state-title">${t("products.noProducts")}</div></div></td></tr>`;return}e.innerHTML=St.map(a=>`
      <tr>
    ...
    `).join(""),e.querySelectorAll(".edit-btn").forEach(a=>a.addEventListener("click",()=>te(a.dataset.id))),e.querySelectorAll(".del-btn").forEach(a=>a.addEventListener("click",()=>je(a.dataset.id))),z(Gt,K,50,"products-pagination",a=>{K=a,N()})}catch(s){h(s)}}function Re(){var s,n,a,o;let e;(s=document.getElementById("product-search"))==null||s.addEventListener("input",r=>{clearTimeout(e),e=setTimeout(()=>{ct.search=r.target.value,K=1,N()},400)}),(n=document.getElementById("category-filter"))==null||n.addEventListener("change",r=>{ct.category_id=r.target.value,K=1,N()}),(a=document.getElementById("low-stock-filter"))==null||a.addEventListener("change",r=>{ct.low_stock=r.target.checked?"true":"",K=1,N()}),(o=document.getElementById("add-product-btn"))==null||o.addEventListener("click",()=>te(null))}async function te(e){let s={};if(e)try{s=(await H.get(e)).product}catch(o){h(o);return}const n=Zt.map(o=>`<option value="${o.id}" ${s.category_id===o.id?"selected":""}>${o.name}</option>`).join(""),a=document.createElement("form");a.innerHTML=`
  ...
  `,w({title:t(e?"products.edit":"products.add"),body:a,size:"lg",footer:[{label:t("app.cancel"),class:"btn-secondary",action:({close:o})=>o()},{label:t("app.save"),class:"btn-primary",action:async({close:o})=>{var i;const r=Object.fromEntries(new FormData(a));if(!r.name){y(t("products.name")+" "+t("app.required"));return}r.is_active=((i=a.querySelector("[name=is_active]"))==null?void 0:i.checked)??!0;try{e?await H.update(e,r):await H.create(r),$(t("products.saved")),o(),N()}catch(l){y(l.message)}}}]})}async function je(e){if(await M({message:t("products.deleteConfirm"),type:"warning"}))try{await H.delete(e),$(t("products.saved")),N()}catch(n){h(n)}}function z(e,s,n,a,o){var p,u;const r=document.getElementById(a);if(!r)return;const i=Math.ceil(e/n),l=(s-1)*n+1,d=Math.min(s*n,e);r.innerHTML=`
    <span class="pagination-info">
      ${t("table.showing").replace("{from}",l).replace("{to}",d).replace("{total}",e)}
    </span>
  ...
  `,(p=document.getElementById(`${a}-prev`))==null||p.addEventListener("click",()=>o(s-1)),(u=document.getElementById(`${a}-next`))==null||u.addEventListener("click",()=>o(s+1))}let dt=1,W={start_date:"",end_date:"",sale_type:""};async function He(e){var n;k(t("sales.title"));const s=new Date().toISOString().slice(0,10);e.innerHTML=`
    <div class="page-header">
  ...
  `,W.start_date=s,W.end_date=s,await yt(),(n=document.getElementById("sales-filter-btn"))==null||n.addEventListener("click",()=>{var a,o,r;W.start_date=(a=document.getElementById("sale-from"))==null?void 0:a.value,W.end_date=(o=document.getElementById("sale-to"))==null?void 0:o.value,W.sale_type=(r=document.getElementById("sale-type-filter"))==null?void 0:r.value,dt=1,yt()})}async function yt(){const e=document.getElementById("sales-tbody");e&&(e.innerHTML='<tr><td colspan="9"><div class="loading-spinner"><div class="spinner"></div></div></td></tr>');try{const s={page:dt,limit:50,...W};Object.keys(s).forEach(o=>{s[o]||delete s[o]});const n=await $t.list(s),a=n.sales;if(!a.length){e&&(e.innerHTML=`<tr><td colspan="9"><div class="empty-state"><div class="empty-state-icon">📋</div><div class="empty-state-title">${t("sales.noSales")}</div></div></td></tr>`);return}e&&(e.innerHTML=a.map(o=>`
      <tr>
    ...
    `).join("")),e==null||e.querySelectorAll(".view-btn").forEach(o=>o.addEventListener("click",()=>ze(o.dataset.id))),e==null||e.querySelectorAll(".void-btn").forEach(o=>o.addEventListener("click",()=>Oe(o.dataset.id))),z(n.total,dt,50,"sales-pagination",o=>{dt=o,yt()})}catch(s){h(s)}}async function ze(e){const s=document.createElement("div");s.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>',w({title:t("sales.viewInvoice"),body:s,size:"lg",footer:[{label:t("app.close"),class:"btn-secondary",action:({close:n})=>n()}]});try{const{sale:n,items:a}=await $t.get(e);s.innerHTML=`
    ...
    `}catch(n){s.innerHTML=`<p>${n.message}</p>`}}async function Oe(e){if(!await M({message:t("sales.voidConfirm"),type:"danger",confirmLabel:t("sales.void")}))return;const n=document.createElement("form");n.innerHTML=`
    <div class="form-group">
  ...
  `,tt.start_date=s,tt.end_date=s,await gt(),(n=document.getElementById("pur-filter-btn"))==null||n.addEventListener("click",()=>{var o,r;tt.start_date=(o=document.getElementById("pur-from"))==null?void 0:o.value,tt.end_date=(r=document.getElementById("pur-to"))==null?void 0:r.value,pt=1,gt()}),(a=document.getElementById("new-purchase-btn"))==null||a.addEventListener("click",()=>Ue())}async function gt(){const e=document.getElementById("purchases-tbody");e&&(e.innerHTML='<tr><td colspan="7"><div class="loading-spinner"><div class="spinner"></div></div></td></tr>');try{const s={page:pt,limit:50,...tt};Object.keys(s).forEach(o=>{s[o]||delete s[o]});const n=await Bt.list(s),a=n.purchases;if(!a.length){e&&(e.innerHTML=`<tr><td colspan="7"><div class="empty-state"><div class="empty-state-icon">📦</div><div class="empty-state-title">${t("purchases.noPurchases")}</div></div></td></tr>`);return}e&&(e.innerHTML=a.map(o=>`
      <tr>
        <td style="font-family:monospace; font-size:0.8rem; font-weight:600;">${o.invoice_no}</td>
    ...
    `).join("")),e==null||e.querySelectorAll(".view-btn").forEach(o=>o.addEventListener("click",()=>Ne(o.dataset.id))),z(n.total,pt,50,"purchases-pagination",o=>{pt=o,gt()})}catch(s){h(s)}}async function Ne(e){const s=document.createElement("div");s.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>',w({title:t("purchases.title"),body:s,size:"lg",footer:[{label:t("app.close"),class:"btn-secondary",action:({close:n})=>n()}]});try{const{purchase:n,items:a}=await Bt.get(e);s.innerHTML=`
      <div style="display:flex; justify-content:space-between; margin-bottom:1rem;">
    ...
    `}catch(n){s.innerHTML=`<p>${n.message}</p>`}}async function Ue(){P=[];let e=[],s=[];try{const[r,i]=await Promise.all([A.list({limit:500}),T.list()]);e=r.suppliers,s=i.accounts.filter(l=>l.type!=="capital")}catch{}const n=new Date().toISOString().slice(0,10),a=document.createElement("div"),o=()=>{const r=P.reduce((v,b)=>v+(b.qty*b.unit_cost-b.discount),0);a.innerHTML=`
      <div class="form-row cols-2" style="margin-bottom:1rem;">
        <div class="form-group">
          ...
          <select id="pur-supplier" class="form-control">
            <option value="">${t("app.selectOption")}</option>
            ${e.map(v=>`<option value="${v.id}">${v.name}</option>`).join("")}
          </select>
        </div>
        <div class="form-group">
        ...
        <tbody>
          ${P.map((v,b)=>`
            <tr class="item-row" data-idx="${b}">
              <td>${v.name}</td>
              <td class="text-right"><input type="number" class="form-control item-qty" data-idx="${b}" value="${v.qty}" min="0.001" step="0.001" style="width:80px; text-align:right;" /></td>
              <td class="text-right"><input type="number" class="form-control item-cost" data-idx="${b}" value="${v.unit_cost}" min="0" step="0.01" style="width:100px; text-align:right;" /></td>
              <td class="text-right"><input type="number" class="form-control item-disc" data-idx="${b}" value="${v.discount}" min="0" step="0.01" style="width:80px; text-align:right;" /></td>
              <td class="text-right amount item-total-cell">${c(v.qty*v.unit_cost-v.discount)}</td>
      ...
      <div class="form-row cols-3">
        ...
        <div class="form-group">
          ...
          <select id="pur-account" class="form-control">
            <option value="">${t("app.selectOption")}</option>
            ${s.map(v=>`<option value="${v.id}" ${v.is_default?"selected":""}>${v.name}</option>`).join("")}
          </select>
        </div>
      </div>
    `;const i=()=>{const v=P.reduce((f,g)=>f+Math.max(0,g.qty*g.unit_cost-g.discount),0);a.querySelectorAll(".item-row").forEach((f,g)=>{const V=P[g];if(!V)return;const _t=f.querySelector(".item-total-cell");_t&&(_t.textContent=c(Math.max(0,V.qty*V.unit_cost-V.discount)))});const b=a.querySelector(".pur-subtotal-cell");b&&(b.textContent=c(v))};a.querySelectorAll(".item-qty").forEach(v=>{v.addEventListener("input",b=>{P[parseInt(b.target.dataset.idx)].qty=parseFloat(b.target.value)||0,i()})}),a.querySelectorAll(".item-cost").forEach(v=>{v.addEventListener("input",b=>{P[parseInt(b.target.dataset.idx)].unit_cost=parseFloat(b.target.value)||0,i()})}),a.querySelectorAll(".item-disc").forEach(v=>{v.addEventListener("input",b=>{P[parseInt(b.target.dataset.idx)].discount=parseFloat(b.target.value)||0,i()})}),a.querySelectorAll(".item-remove").forEach(v=>{v.addEventListener("click",b=>{P.splice(parseInt(b.currentTarget.dataset.idx),1),o()})});const l=a.querySelector("#pur-search-btn"),d=a.querySelector("#pur-prod-search"),p=a.querySelector("#pur-search-results"),u=async()=>{const v=d==null?void 0:d.value;if(v)try{const{products:b}=await H.search(v);if(!p)return;p.innerHTML=b.map(f=>`
          <button type="button" class="btn btn-secondary btn-sm pur-add-product" data-product='${JSON.stringify({id:f.id,name:f.name,unit:f.unit,unit_cost:f.purchase_cost})}' style="margin:2px;">
            ${f.name} (${f.unit}) — ${c(f.purchase_cost)}
          </button>
        `).join(""),p.querySelectorAll(".pur-add-product").forEach(f=>{f.addEventListener("click",()=>{const g=JSON.parse(f.dataset.product);P.push({product_id:g.id,name:g.name,unit:g.unit,qty:1,unit_cost:g.unit_cost,discount:0}),d&&(d.value=""),p&&(p.innerHTML=""),o()})})}catch{}};l==null||l.addEventListener("click",u),d==null||d.addEventListener("keydown",v=>{v.key==="Enter"&&(v.preventDefault(),u())})};o(),w({title:t("purchases.add"),body:a,size:"xl",footer:[{label:t("app.cancel"),class:"btn-secondary",action:({close:r})=>r()},{label:t("app.save"),class:"btn-primary",action:async({close:r})=>{var l,d,p,u,v;if(!P.length){y(t("pos.itemsRequired"));return}const i={supplier_id:((l=a.querySelector("#pur-supplier"))==null?void 0:l.value)||void 0,purchase_date:(d=a.querySelector("#pur-date"))==null?void 0:d.value,items:P.map(b=>({product_id:b.product_id,qty:b.qty,unit_cost:b.unit_cost,discount:b.discount})),discount:parseFloat((p=a.querySelector("#pur-discount"))==null?void 0:p.value)||0,paid:parseFloat((u=a.querySelector("#pur-paid"))==null?void 0:u.value)||0,account_id:((v=a.querySelector("#pur-account"))==null?void 0:v.value)||void 0};try{const{purchase:b}=await Bt.create(i);$(`${t("purchases.saved")} · ${b.invoice_no}`),r(),gt()}catch(b){y(b.message)}}}]})}let ut=1,ee="";async function Ve(e){k(t("customers.title")),e.innerHTML=`
    <div class="page-header">
  ...
  `,await X(),Ge()}async function X(){const e=document.getElementById("customers-tbody");e&&(e.innerHTML='<tr><td colspan="5"><div class="loading-spinner"><div class="spinner"></div></div></td></tr>');try{const s=await B.list({page:ut,limit:50,search:ee}),n=s.customers;if(!e)return;if(!n.length){e.innerHTML=`<tr><td colspan="5"><div class="empty-state"><div class="empty-state-icon">👥</div><div class="empty-state-title">${t("customers.noCustomers")}</div></div></td></tr>`;return}e.innerHTML=n.map(a=>`
      <tr>
        <td>
          <div style="font-weight:500;">${a.name}</div>
  ...
  `,w({title:t(e?"customers.edit":"customers.add"),body:n,size:"md",footer:[{label:t("app.cancel"),class:"btn-secondary",action:({close:a})=>a()},{label:t("app.save"),class:"btn-primary",action:async({close:a})=>{var r;const o=Object.fromEntries(new FormData(n));if(!o.name){y(t("customers.name")+" required");return}e&&(o.is_active=((r=n.querySelector("[name=is_active]"))==null?void 0:r.checked)??!0);try{e?await B.update(e,o):await B.create(o),$(t("customers.saved")),a(),X()}catch(i){y(i.message)}}}]})}async function We(e){if(await M({message:t("customers.deleteConfirm"),type:"danger"}))try{await B.delete(e),$(t("customers.saved")),X()}catch(n){h(n)}}async function Je(e,s){const n=document.createElement("div");n.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>',w({title:`${t("ledger.title")} — ${s}`,body:n,size:"xl",footer:[{label:t("app.close"),class:"btn-secondary",action:({close:a})=>a()}]});try{const{ledger:a}=await B.ledger(e);if(!a.length){n.innerHTML=`<div class="empty-state"><div class="empty-state-icon">📋</div><div class="empty-state-title">${t("ledger.noEntries")}</div></div>`;return}n.innerHTML=`
      <div class="table-wrapper">
        <table class="table">
          <thead><tr>
            <th>${t("ledger.date")}</th>
  ...
  `,await Y(),(n=document.getElementById("add-supplier-btn"))==null||n.addEventListener("click",()=>ne(null));let s;(a=document.getElementById("supplier-search"))==null||a.addEventListener("input",o=>{clearTimeout(s),s=setTimeout(()=>{se=o.target.value,mt=1,Y()},400)})}async function Y(){const e=document.getElementById("suppliers-tbody");e&&(e.innerHTML='<tr><td colspan="5"><div class="loading-spinner"><div class="spinner"></div></div></td></tr>');try{const s=await A.list({page:mt,limit:50,search:se}),n=s.suppliers;if(!n.length){e&&(e.innerHTML=`<tr><td colspan="5"><div class="empty-state"><div class="empty-state-icon">🏭</div><div class="empty-state-title">${t("suppliers.noSuppliers")}</div></div></td></tr>`);return}e&&(e.innerHTML=n.map(a=>`
      <tr>
    ...
    ${e?`<div class="form-check"><input type="checkbox" name="is_active" ${s.is_active?"checked":""} /><label class="form-label" style="margin:0;">${t("app.active")}</label></div>`:""}
  `,w({title:t(e?"suppliers.edit":"suppliers.add"),body:n,size:"md",footer:[{label:t("app.cancel"),class:"btn-secondary",action:({close:a})=>a()},{label:t("app.save"),class:"btn-primary",action:async({close:a})=>{var r;const o=Object.fromEntries(new FormData(n));e&&(o.is_active=((r=n.querySelector("[name=is_active]"))==null?void 0:r.checked)??!0);try{e?await A.update(e,o):await A.create(o),$(t("suppliers.saved")),a(),Y()}catch(i){y(i.message)}}}]})}async function Ye(e){if(await M({message:t("suppliers.deleteConfirm"),type:"danger"}))try{await A.delete(e),Y()}catch(n){h(n)}}async function Xe(e,s){const n=document.createElement("div");n.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>',w({title:`${t("ledger.title")} — ${s}`,body:n,size:"xl",footer:[{label:t("app.close"),class:"btn-secondary",action:({close:a})=>a()}]});try{const{ledger:a}=await A.ledger(e);if(!a.length){n.innerHTML=`<div class="empty-state"><div class="empty-state-title">${t("ledger.noEntries")}</div></div>`;return}n.innerHTML=`<div class="table-wrapper"><table class="table"><thead><tr><th>${t("ledger.date")}</th><th>${t("ledger.description")}</th><th class="text-right">${t("ledger.debit")}</th><th class="text-right">${t("ledger.credit")}</th><th class="text-right">${t("ledger.balance")}</th></tr></thead><tbody>
  ...
  `,w({title:`${t("suppliers.makePayment")} — ${s}`,body:r,size:"md",footer:[{label:t("app.cancel"),class:"btn-secondary",action:({close:i})=>i()},{label:t("payments.makePayment"),class:"btn-success",action:async({close:i})=>{const l=Object.fromEntries(new FormData(r));l.supplier_id=e;try{await Q.supplierCreate(l),$(t("payments.recorded")),i(),Y()}catch(d){y(d.message)}}}]})}let rt=[];async function ta(e){k(t("categories.title")),e.innerHTML=`
    <div class="page-header">
  ...
  `,await Mt(),ea()}async function Mt(){const e=document.getElementById("categories-tbody");e&&(e.innerHTML='<tr><td colspan="6"><div class="loading-spinner"><div class="spinner"></div></div></td></tr>');try{if(rt=(await st.list()).categories||[],!e)return;if(!rt.length){e.innerHTML=`
        <tr>
          <td colspan="6">
            <div class="empty-state">
              <div class="empty-state-icon">🏷</div>
  ...
  `;const s=async a=>{document.querySelectorAll(".inv-tab").forEach(r=>{r.className=r.dataset.tab===a?"btn btn-primary inv-tab":"btn btn-ghost inv-tab"});const o=document.getElementById("inv-output");if(o){o.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>';try{a==="movements"&&await na(o),a==="lowstock"&&await oa(o),a==="summary"&&await ra(o)}catch(r){h(r)}}};document.querySelectorAll(".inv-tab").forEach(a=>a.addEventListener("click",()=>s(a.dataset.tab))),await s("movements"),(n=document.getElementById("adjust-btn"))==null||n.addEventListener("click",()=>re())}async function na(e){const{movements:s,total:n}=await wt.movements({limit:100});if(!s.length){e.innerHTML=`<div class="empty-state"><div class="empty-state-icon">📦</div><div class="empty-state-title">${t("app.noData")}</div></div>`;return}e.innerHTML=`
    <div class="table-wrapper">
      <table class="table">
        <thead><tr>
          <th>${t("app.date")}</th>
        ...
        <tbody>
          ${s.map(a=>`
            <tr>
              <td style="font-size:0.8rem;">${Ct(a.created_at)}</td>
              <td>
  ...
  `}async function oa(e){const{products:s,count:n}=await wt.lowStock();if(!s.length){e.innerHTML='<div class="empty-state"><div class="empty-state-icon">✅</div><div class="empty-state-title" style="color:var(--color-success);">All stock levels are adequate</div></div>';return}e.innerHTML=`
  ...
  `,e.querySelectorAll(".adj-btn").forEach(a=>a.addEventListener("click",()=>re(a.dataset.id,a.dataset.name)))}async function ra(e){const{products:s,totals:n}=await wt.summary();e.innerHTML=`
  ...
  `}async function re(e=null,s=""){let n=[];try{n=(await H.list({limit:500})).products}catch{}const a=document.createElement("form");a.innerHTML=`
    <div class="form-group">
  ...
  `,w({title:t("inventory.adjust"),body:a,size:"md",footer:[{label:t("app.cancel"),class:"btn-secondary",action:({close:o})=>o()},{label:t("app.confirm"),class:"btn-primary",action:async({close:o})=>{const r=Object.fromEntries(new FormData(a));if(!r.product_id||!r.qty){y("Product and quantity are required");return}try{await wt.adjust(r),$(t("inventory.adjustSuccess")),o()}catch(i){y(i.message)}}}]})}let S="customers",j=1,q={start_date:"",end_date:"",entity_id:""};async function Et(e,s={}){const n=window.location.hash,a=n.includes("/suppliers"),o=n.includes("/new");S=a?"suppliers":"customers",j=1,q={start_date:"",end_date:"",entity_id:""};const r=t(S==="customers"?"payments.customerTitle":"payments.supplierTitle");k(r),new Date().toISOString().slice(0,10),e.innerHTML=`
    <div class="page-header">
  ...
  `,await ia(),await F(),la(),o&&ie()}async function ia(){const e=document.getElementById("pay-entity-filter");if(e)try{if(S==="customers"){const n=(await B.list({limit:500})).customers||[];e.innerHTML=`<option value="">${t("payments.customer")} (${t("app.all")})</option>`+n.map(a=>`<option value="${a.id}">${a.name} (${a.phone||"—"})</option>`).join("")}else{const n=(await A.list({limit:500})).suppliers||[];e.innerHTML=`<option value="">${t("payments.supplier")} (${t("app.all")})</option>`+n.map(a=>`<option value="${a.id}">${a.name} (${a.phone||"—"})</option>`).join("")}}catch{}}async function F(){const e=document.getElementById("payments-tbody");e&&(e.innerHTML='<tr><td colspan="8"><div class="loading-spinner"><div class="spinner"></div></div></td></tr>');try{const s={page:j,limit:20};q.start_date&&(s.start_date=q.start_date),q.end_date&&(s.end_date=q.end_date),q.entity_id&&(S==="customers"?s.customer_id=q.entity_id:s.supplier_id=q.entity_id);const n=S==="customers"?await Q.customerList(s):await Q.supplierList(s),a=n.payments||[],o=n.total||0;if(!e)return;if(!a.length){e.innerHTML=`
        <tr>
          <td colspan="8">
            <div class="empty-state">
              <div class="empty-state-icon">💳</div>
      ...
      `,z(0,1,20,"payments-pagination",()=>{});return}e.innerHTML=a.map(r=>`
      <tr>
    ...
    `).join(""),e.querySelectorAll(".view-payment-btn").forEach(r=>{r.addEventListener("click",()=>{const i=a.find(l=>l.id===parseInt(r.dataset.id));i&&ca(i)})}),z(o,j,20,"payments-pagination",r=>{j=r,F()})}catch(s){h(s)}}function la(){var e,s,n,a,o;document.querySelectorAll(".pay-tab").forEach(r=>{r.addEventListener("click",()=>{const i=r.dataset.type;C(i==="customers"?"/payments/customers":"/payments/suppliers")})}),(e=document.getElementById("add-payment-btn"))==null||e.addEventListener("click",()=>ie()),(s=document.getElementById("pay-from"))==null||s.addEventListener("change",r=>{q.start_date=r.target.value,j=1,F()}),(n=document.getElementById("pay-to"))==null||n.addEventListener("change",r=>{q.end_date=r.target.value,j=1,F()}),(a=document.getElementById("pay-entity-filter"))==null||a.addEventListener("change",r=>{q.entity_id=r.target.value,j=1,F()}),(o=document.getElementById("pay-filter-reset"))==null||o.addEventListener("click",()=>{document.getElementById("pay-from").value="",document.getElementById("pay-to").value="",document.getElementById("pay-entity-filter").value="",q={start_date:"",end_date:"",entity_id:""},j=1,F()})}async function ie(){var r;const e=S==="customers",s=new Date().toISOString().slice(0,10);let n=[],a=[];try{const[i,l]=await Promise.all([e?B.list({limit:500}):A.list({limit:500}),T.list()]);n=e?i.customers||[]:i.suppliers||[],a=l.accounts||[]}catch(i){h(i);return}const o=t(e?"payments.receivePayment":"payments.makePayment");`${t(e?"payments.customer":"payments.supplier")}`,`${t("app.select")}${n.map(i=>`
          ...
          `),a.document.close()}}]})}let vt=1,et={start_date:"",end_date:""};async function da(e){var n,a;k(t("expenses.title"));const s=new Date().toISOString().slice(0,10);e.innerHTML=`
    <div class="page-header">
  ...
  `,et.start_date=s,et.end_date=s,await ht(),(n=document.getElementById("exp-filter-btn"))==null||n.addEventListener("click",()=>{var o,r;et.start_date=(o=document.getElementById("exp-from"))==null?void 0:o.value,et.end_date=(r=document.getElementById("exp-to"))==null?void 0:r.value,vt=1,ht()}),(a=document.getElementById("add-expense-btn"))==null||a.addEventListener("click",()=>pa())}async function ht(){const e=document.getElementById("expenses-tbody");e&&(e.innerHTML='<tr><td colspan="5"><div class="loading-spinner"><div class="spinner"></div></div></td></tr>');try{const s={page:vt,limit:50,...et};Object.keys(s).forEach(o=>{s[o]||delete s[o]});const n=await Tt.list(s),a=n.expenses;if(!a.length){e&&(e.innerHTML=`<tr><td colspan="5"><div class="empty-state"><div class="empty-state-icon">💳</div><div class="empty-state-title">${t("expenses.noExpenses")}</div></div></td></tr>`);return}e&&(e.innerHTML=a.map(o=>`
      <tr>
    ...
    `).join("")),z(n.total,vt,50,"expenses-pagination",o=>{vt=o,ht()})}catch(s){h(s)}}async function pa(){let e=[],s=[];try{const[o,r]=await Promise.all([Tt.categories(),T.list()]);e=o.categories,s=r.accounts.filter(i=>i.type!=="capital")}catch{}const n=new Date().toISOString().slice(0,10),a=document.createElement("form");a.innerHTML=`
    <div class="form-row cols-2">
      <div class="form-group">
  ...
  `,w({title:t("expenses.add"),body:a,size:"md",footer:[{label:t("app.cancel"),class:"btn-secondary",action:({close:o})=>o()},{label:t("app.save"),class:"btn-primary",action:async({close:o})=>{const r=Object.fromEntries(new FormData(a));if(!r.category_id||!r.amount||!r.account_id){y("All required fields must be filled");return}try{await Tt.create(r),$(t("expenses.saved")),o(),ht()}catch(i){y(i.message)}}}]})}async function ua(e){var s;k(t("accounts.title")),e.innerHTML=`
    <div class="page-header">
  ...
  `,await nt(),(s=document.getElementById("add-account-btn"))==null||s.addEventListener("click",()=>ga())}async function nt(){const e=document.getElementById("accounts-content");if(e)try{const{accounts:s,totals:n}=await T.list();let a=`
  ...
  `;let a="pl";document.querySelectorAll(".report-tab").forEach(r=>{r.addEventListener("click",()=>{a=r.dataset.tab,document.querySelectorAll(".report-tab").forEach(i=>{i.className=i.dataset.tab===a?"btn btn-primary report-tab":"btn btn-ghost report-tab"})})}),(o=document.getElementById("generate-btn"))==null||o.addEventListener("click",async()=>{var d,p;const r=(d=document.getElementById("report-from"))==null?void 0:d.value,i=(p=document.getElementById("report-to"))==null?void 0:p.value,l=document.getElementById("report-output");if(l){l.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>';try{if(a==="pl"){const u=await lt.profitLoss({start_date:r,end_date:i});fa(l,u,r,i)}else if(a==="sales"){const u=await lt.sales({start_date:r,end_date:i});$a(l,u)}else{const u=await lt.purchases({start_date:r,end_date:i});wa(l,u)}}catch(u){h(u),l.innerHTML=`<div class="empty-state"><div class="empty-state-icon">⚠️</div><div class="empty-state-title">${u.message}</div></div>`}}})}function fa(e,s,n,a){const{income:o,cogs:r,gross_profit:i,gross_margin_pct:l,expenses:d,net_profit:p,net_margin_pct:u}=s,v=p>=0;e.innerHTML=`
    <div class="card" style="margin-bottom:1.5rem;">
      ...
      <div class="stats-grid" style="margin-bottom:1.5rem;">
        ...
        <div class="stat-card" style="--card-accent:#ef4444;"><div class="stat-label">${t("reports.totalExpenses")}</div><div class="stat-value" style="color:var(--color-danger);">${c(d.total)}</div></div>
        <div class="stat-card" style="--card-accent:${v?"#10b981":"#ef4444"};">
          <div class="stat-label">${t("reports.netProfit")}</div>
          <div class="stat-value" style="color:${v?"var(--color-success)":"var(--color-danger)"};">${c(p)}</div>
      ...
      <div>
        ...
        <div class="table-wrapper"><table class="table"><thead><tr><th>${t("expenses.category")}</th><th class="text-right">${t("expenses.amount")}</th><th class="text-right">%</th></tr></thead>
          <tbody>${d.by_category.map(b=>`<tr><td>${b.category}</td><td class="text-right amount">${c(b.amount)}</td><td class="text-right text-muted" style="font-size:0.8rem;">${d.total>0?(b.amount/d.total*100).toFixed(1):0}%</td></tr>`).join("")}</tbody>
        </table></div>
      </div>`:""}
    </div>
  ...
  `}async function xa(e){var s;k(t("users.title")),e.innerHTML=`
    <div class="page-header">
  ...
  `,await Dt(),(s=document.getElementById("add-user-btn"))==null||s.addEventListener("click",()=>le(null))}async function Dt(){const e=document.getElementById("users-tbody");try{const{users:s}=await J.list();if(!s.length){e&&(e.innerHTML=`<tr><td colspan="6"><div class="empty-state"><div class="empty-state-title">${t("users.noUsers")}</div></div></td></tr>`);return}e&&(e.innerHTML=s.map(n=>`
      <tr>
        ...
        <td style="font-size:0.8rem; color:var(--text-muted);">${n.last_login?Ct(n.last_login):"—"}</td>
  ...
  `,w({title:t("users.resetPassword"),body:s,size:"sm",footer:[{label:t("app.cancel"),class:"btn-secondary",action:({close:n})=>n()},{label:t("users.resetPassword"),class:"btn-primary",action:async({close:n})=>{const{password:a}=Object.fromEntries(new FormData(s));if(!a||a.length<6){y("Password must be at least 6 characters");return}try{await J.resetPassword(e,a),$(t("users.passwordReset")),n()}catch(o){y(o.message)}}}]})}async function _a(e){if(await M({message:t("users.deactivateConfirm"),type:"warning"}))try{await J.update(e,{is_active:!1}),Dt()}catch(n){h(n)}}async function ka(e){k(t("settings.title")),e.innerHTML=`
    <div class="page-header"><h1 class="page-title">${t("settings.title")}</h1></div>
    <div class="loading-spinner"><div class="spinner"></div></div>
  `;try{const{settings:s}=await Qt.get();Sa(e,s)}catch(s){h(s)}}function Sa(e,s){var n,a,o,r,i,l;e.innerHTML=`
    <div class="page-header"><h1 class="page-title">${t("settings.title")}</h1></div>
      ...
      <div class="card" style="grid-column:1 / -1;">
        ...
        <div class="grid-3" style="gap:1rem;">
          ...
          <div>
            ...
            <div style="font-weight:600;">${(n=I.user)==null?void 0:n.full_name} (${(a=I.user)==null?void 0:a.role})</div>
          </div>
          <div>
  ...
  `,(o=document.getElementById("company-form"))==null||o.addEventListener("submit",async d=>{d.preventDefault();const p=Object.fromEntries(new FormData(d.target));try{await Qt.update(p),p.default_language&&p.default_language!==at()&&bt(p.default_language),$(t("settings.saved"))}catch(u){h(u)}}),(r=document.getElementById("password-form"))==null||r.addEventListener("submit",async d=>{d.preventDefault();const p=Object.fromEntries(new FormData(d.target));if(p.new_password!==p.confirm_password){y(t("validation.passwordMismatch"));return}try{await ft.changePassword({current_password:p.current_password,new_password:p.new_password}),$(t("auth.passwordChanged")),d.target.reset()}catch(u){y(u.message)}}),(i=document.getElementById("export-backup-btn"))==null||i.addEventListener("click",async()=>{try{$("Generating backup...");const d=await Ot.export(),p=new Blob([JSON.stringify(d,null,2)],{type:"application/json"}),u=URL.createObjectURL(p),v=document.createElement("a");v.href=u,v.download=`coretrade_backup_${new Date().toISOString().slice(0,10)}.json`,v.click(),URL.revokeObjectURL(u)}catch(d){h(d)}}),(l=document.getElementById("import-backup-input"))==null||l.addEventListener("change",async d=>{var v;const p=(v=d.target.files)==null?void 0:v[0];if(!p)return;if(!await M({title:"Restore Database",message:"Restoring a backup will overwrite current tables with data from the backup file. Are you sure you want to proceed?",type:"danger",confirmLabel:"Restore Database"})){d.target.value="";return}try{const b=await p.text(),f=JSON.parse(b);await Ot.import(f),$("Database restored successfully! Reloading..."),setTimeout(()=>window.location.reload(),1500)}catch(b){y(b.message||"Failed to parse or restore backup")}finally{d.target.value=""}})}const ce=document.getElementById("app");let Wt=!1;function E(e){return async s=>{var a;document.getElementById("page-outlet")||Ee(ce);const n=Se();n&&(n.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>',await e(n,s)),(a=document.getElementById("initial-loader"))==null||a.remove()}}x("/login",async()=>{var e;It(ce),(e=document.getElementById("initial-loader"))==null||e.remove()});x("/",E(Le));x("/pos",E(Te));x("/sales",E(He));x("/purchases",E(Fe));x("/customers",E(Ve));x("/suppliers",E(Qe));x("/products",E(Me));x("/categories",E(ta));x("/inventory",E(sa));x("/expenses",E(da));x("/accounts",E(ua));x("/reports",E(ha));x("/users",E(xa));x("/settings",E(ka));x("/payments/customers",E(Et));x("/payments/customers/new",E(Et));x("/payments/suppliers",E(Et));x("/payments/suppliers/new",E(Et));de(async()=>{var e;I.isAuthenticated()?E(s=>{s.innerHTML=`
      ...
      `})({}):C("/login"),(e=document.getElementById("initial-loader"))==null||e.remove()});pe(async e=>{if(!Wt){try{const{user:n}=await ft.me();I.user=n}catch{I.user=null}Wt=!0}const s=I.isAuthenticated();return!s&&e!=="/login"?(C("/login"),!1):s&&e==="/login"||e==="/users"&&!I.isAdmin()?(C("/"),!1):!0});ve();"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").catch(()=>{})});
